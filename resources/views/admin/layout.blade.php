  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/products"><i class="fa fa-sticky-note-o"></i> <span>Товар</span></a></li>
...
<!--esi dues sarqel vor stugi edit mej ete 1 a urem dni chekbox ete zroya chdni adminki mej-->
<script>
  $('.minimal').each(function(e){
    if($(this).val() == 1){
